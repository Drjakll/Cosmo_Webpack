...
var clientConfig = {
    ...
    resolve: {
        ...
        alias: {
				...
				'@connection_list_editor': path.resolve(__dirname, './Development/Client/App_Entrance/Entrance_Options/Logged_In/Screen/Profile/Layer_1_Private/Connections_Editor/Connection_List_Editor/connection_list_editor.js'),
				...
				'@image_container': path.resolve(__dirname, './Development/Client/Universal_Components/Image_Container/image_container.js'),
				...
				'@drag_scroll': path.resolve(__dirname, './Development/Client/Utilities/Drag_Scroll/drag_scroll.js'),
