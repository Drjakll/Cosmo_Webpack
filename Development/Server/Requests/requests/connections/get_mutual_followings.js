let request = function ({sql}) {
    ...
    this.req_path = "/get_mutual_followings/:target_id";
    this.req_type = "get";
    this.callbacks = ["central_auth","get_mutual_followings"];
    ...
    this.req = async (req, res) => {
        ...
        let query = `
            ...
            where
                c.followed_id = d.followed_id and ua.id = c.followed_id
        `;
        ...
        try {
            ...
            res.status(500).json({message: "Error retrieving mutual followings", mutuals: null});
        }   
