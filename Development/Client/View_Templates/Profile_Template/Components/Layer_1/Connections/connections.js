...
class Connections extends Component {
    ...
    render(){
        ...
        let {visitor_user_account, owner_user_account, followers, followings, follow_req_status} = this.state;
        ...
        return <div id="connections-bar">
            ...
            <div id="request-buttons">
                ...
                {visitor_user_account.id !== owner_user_account.id && follow_req_status !== "accepted" ? this.Show_Follow_Request_Button() : ""}
