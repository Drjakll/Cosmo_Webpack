	...
	constructor(props){
        ...
        Setup_Socket_Event = (socket)=>{
            ...
            socket?.on('received_knowledgement', ({from_tag, from_account})=>{
                ...
                participants[from_tag.id] = {account_data: from_account, room_tag: from_tag};
            ...
            return <div id="viewer-display">
                ...
                <div id="the-list">
                    ...
                    {Object.keys(participants).map((key, ind)=>{
                        ...
                        let {account_data, room_tag} = participants[key];
                        ...
                        return <div className="participant-entry-wrapper" 
                            ...
                            <Viewer_Entry account_data={account_data} room_tag={room_tag}/>
